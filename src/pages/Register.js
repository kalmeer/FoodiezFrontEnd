...
const Register = () => {
  ...
  return (
    <div className="bg-orange-100 min-h-screen flex items-center justify-center absolute inset-0 z-[-1] login-container font-sans">
      <div className="max-w-md w-full px-6 py-8 bg-orange-500 rounded-md shadow-md">
        ...
        <form onSubmit={handleFormSubmit}>
          ...
          <button
            style={{ width: "100%" }}
            type="submit"
            className="text-orange-100  hover:bg-orange-600 hover:text-white px-3 py-2 rounded-md text-sm font-medium"
